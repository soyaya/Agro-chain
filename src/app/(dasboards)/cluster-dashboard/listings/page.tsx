...
// A cluster farmer's own supply listings, distinct from the listings they
// review from OTHER farmers (see /cluster-dashboard/pending-approvals).
// Cluster accounts create listings through the same endpoint regular
// farmers use (auto-approved instead of needing review), so this reuses
// the same real, already-scoped farmer listings endpoint.
          ...
          >
            <div>
              ...
              <p className="mt-2 text-(--text-colour)">
                Manage your own supply listings and track approval status
              </p>
            </div>
