...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Source premium Nigerian agricultural products directly from verified farmers. Best prices, secure payments, end-to-end logistics.",
    siteName: "Debridger",
    images: [
      {
        url: "/og-image.png",
  ...
  twitter: {
    ...
    description:
      "Premium crops. Verified suppliers. Seamless export logistics.",
    images: {
