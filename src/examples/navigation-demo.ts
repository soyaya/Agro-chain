...
import { enhancedFarmerDashboardConfig, buyerDashboardConfig } from '../models/models';
...
function FarmerDashboardExample() {
  ...
  console.log('Should Show Financial Services:', nav.shouldShowFinancialServices); // true
  ...
  console.log('Credit Feature Enabled:', nav.isFinancialFeatureEnabled('credit')); // true
...
function BuyerDashboardExample() {
  ...
  console.log('Financial Items Count:', nav.financialItems.length); // 0
  console.log('Should Show Financial Services:', nav.shouldShowFinancialServices); // false
